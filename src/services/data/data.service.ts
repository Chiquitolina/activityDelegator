    ...
    this.dbServ.getLastFourSorts().subscribe({
      next: (lastThreeSorts) => {
        ...
        for (let i = 0; i < this.activities.length; i++) {
          ...
          // Ajusta el número de elegidos para actividades específicas
          if (
          ...
          // Para asegurarte de que Gustavo no esté en Cocina y Lava
          if (
            (activity.name === 'Cocina' &&
              activity.elegidos
            ...
            this.newSort(array)
            console.log('Error: Gustavo no puede estar en Cocina o Lava');
          }
          ...
          if (
            ...
            this.newSort(array)
            console.log('Error: Ivan no puede estar en Levanta y barre o Lava');
          }
        }
